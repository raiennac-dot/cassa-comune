...
export default function CassaComuneLive() {
    ...
    try {
      ...
      if (authMode === "signup") {
        ...
        if (data.access_token) {
          ...
          setAuthError(
            "Registrazione creata. Controlla la tua email se richiesta e poi accedi."
          );
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const [
        ...
        fetch(
          `${SUPABASE_URL}/rest/v1/approvals?select=*`,
          {
            headers: authHeaders(
              session.access_token
            ),
  ...
  async function submitRequest() {
    ...
    if (!form.reason.trim()) {
      ...
      setFormError(
        "Inserisci il motivo della spesa."
      );
    ...
    if (amt > balance) {
      ...
      setFormError(
        `Fondi insufficienti. Saldo disponibile: ${currency(
          balance
        )}. Importo richiesto: ${currency(amt)}.`
      );
    ...
    try {
      ...
      showToast(
        "Richiesta salvata e visibile a tutti i componenti."
      );
  ...
  async function addMember() {
    ...
    if (
      ...
      setInviteError(
        "Inserisci nome, email, telefono e password provvisoria."
      );
    ...
    if (
      ...
      setInviteError(
        "La password provvisoria deve avere almeno 6 caratteri."
      );
    ...
    if (
      ...
      setInviteError(
        "Limite di 10 componenti raggiunto."
      );
    ...
    try {
      ...
      showToast(
        `${newName} aggiunto correttamente.`
      );
      ...
      <div className="app">
        ...
        <div className="auth-wrap">
          ...
          <div className="disclaimer">
            ...
            Cassa Comune · gestione condivisa,
            votazione unanime e controllo del saldo.
          ...
          <div className="brand">
            ...
            <div>
              ...
              <div className="sub">
                ...
                {currentMember
                  ? `Accesso come ${currentMember.name}`
                  : "Caricamento profilo..."}
          ...
          <div>
            ...
            {sorted.length ===
              ...
              <div className="empty">
                ...
                <div>
                  Nessuna richiesta ancora registrata.
                </div>
                ...
                >
                  ...
                  {status ===
                    ...
                    <div className="voted-note">
                      ...
                      Hai già votato —
                      in attesa degli altri componenti.
                  ...
                  {status ===
                    ...
                    <div className="approved-message">
                      ...
                      Tutti hanno approvato.
                      La spesa può essere eseguita.
